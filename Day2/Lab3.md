...
## 2. Maximum Likelihood Tree Inference
  ...
  You already run a ML tree in the previous practical. Let's consolidate what you learnt:
  ...
  *IQ-TREE output files:*
  ...
  You still have another option, which would be to do both analyses at the same time, find which model is the best for your data, and infer the tree. You can do this with the 'TESTMERGE' option of IQ-tree:
  ```bash
